...
Item {
    ...
    property string lastAction: "lock"
    ...
    function show(scr) {
        ...
        if (target !== null && target !== undefined) {
            ...
            } else if (typeof Quickshell !== "undefined" && Quickshell.screens && Quickshell.screens.length > 0) {
                controller.screen = Quickshell.screens[0];
            }
        }
